...
namespace IkCastle.DynamicProxy.Generators
{
	using System;
...
//#endif
	...
	using IkCastle.Core.Internal;
	using IkCastle.Core.Logging;
	using IkCastle.DynamicProxy.Contributors;
	using IkCastle.DynamicProxy.Generators.Emitters;
	using IkCastle.DynamicProxy.Generators.Emitters.CodeBuilders;
	using IkCastle.DynamicProxy.Generators.Emitters.SimpleAST;
	using IkCastle.DynamicProxy.Internal;

#if SILVERLIGHT
	using IkCastle.DynamicProxy.SilverlightExtensions;
#endif
