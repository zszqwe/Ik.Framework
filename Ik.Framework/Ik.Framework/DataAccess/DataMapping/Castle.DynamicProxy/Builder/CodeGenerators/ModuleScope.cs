...
namespace IBatisNet.CastleDynamicProxy.Builder.CodeGenerators
{
	using System;
	using System.IO;
	...
	public class ModuleScope
	{
        ...
        {
            byte[] keyPair;
            using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("IBatisNet.CastleDynamicProxy.DynProxy.snk"))
            {
