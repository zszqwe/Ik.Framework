...
namespace IBatisNet.Common.Utilities.Objects
{
    ...
    public sealed class ReflectionInfo
	{
		...
		/// 
		/// </summary>
        public static BindingFlags BINDING_FLAGS_PUBLIC_PROPERTY
            = BindingFlags.Public
            | BindingFlags.Instance;
        ...
        private string[] _publicWriteableMemberNames = _emptyStringArray;
        ...
        // (memberName, MemberInfo)
        private Hashtable _publicSetMembers = new Hashtable();
		...
		private ReflectionInfo(Type type) 
		{
            ...
            string[] publicSetArray = new string[_publicSetMembers.Count];
			_publicSetMembers.Keys.CopyTo(publicSetArray,0);
			_publicWriteableMemberNames = publicSetArray;
		}
		...
		private void AddMembers(Type type) 
		{
			...
			for (int i = 0; i < properties.Length; i++) 
			{
                if (properties[i].CanWrite)
                {
                    ...
                    _publicSetMembers[name] = properties[i];
                }
        ...
        public string[] GetPublicWriteableMemberNames()
        {
            return _publicWriteableMemberNames;
        }
