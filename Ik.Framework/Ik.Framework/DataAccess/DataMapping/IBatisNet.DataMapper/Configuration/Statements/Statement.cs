...
namespace IBatisNet.DataMapper.Configuration.Statements
{
    ...
    public class Statement : IStatement
    {
        ...
        /// «ø÷∆∆Ù”√◊‘∂Ø”≥…‰ºÊ»›ƒ£ Ω
        /// </summary>
        [XmlAttribute("forceEnableAutoMapCompatibilityMode")]
        public bool ForceEnableAutoMapCompatibilityMode { get; set; }
        /// <summary>
        /// «ø÷∆Ω˚”√◊‘∂Ø”≥…‰ºÊ»›ƒ£ Ω
        /// </summary>
        [XmlAttribute("forceDisabledAutoMapCompatibilityMode")]
        public bool ForceDisabledAutoMapCompatibilityMode { get; set; }
