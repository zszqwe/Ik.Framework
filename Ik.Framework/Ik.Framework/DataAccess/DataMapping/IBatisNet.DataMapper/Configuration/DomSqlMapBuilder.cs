...
namespace IBatisNet.DataMapper.Configuration
{
	...
	public class DomSqlMapBuilder
	{
        ...
        /// �Զ�ӳ�����ģʽ //add by ����
        /// </summary>
        private const string ATR_USE_AUTO_MAP_COMPATIBILITY_MODE = "useAutoMapCompatibilityMode";
		...
		private void Initialize()
		{
			...
			if (settings!=null)
			{
				foreach (XmlNode setting in settings)
				{
                    ...
                    //add by ����
                    if (setting.Attributes[ATR_USE_AUTO_MAP_COMPATIBILITY_MODE] != null)
                    {
                        string value = NodeUtils.ParsePropertyTokens(setting.Attributes[ATR_USE_AUTO_MAP_COMPATIBILITY_MODE].Value, _configScope.Properties);
                        _configScope.UseAutoMapCompatibilityMode = Convert.ToBoolean(value);
                    }
				}
			}
            ...
            _configScope.SqlMapper.IsUseAutoMapCompatibilityMode = _configScope.UseAutoMapCompatibilityMode;
        ...
        public void ConfigureSqlMap(XmlNode xmlNode)
        {
            _configScope.NodeContext = xmlNode;
            ConfigureSqlMap();
        }
