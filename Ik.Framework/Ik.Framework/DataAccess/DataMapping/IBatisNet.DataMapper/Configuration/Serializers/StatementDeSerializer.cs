...
namespace IBatisNet.DataMapper.Configuration.Serializers
{
	...
	public sealed class StatementDeSerializer
	{
		...
		public static Statement Deserialize(XmlNode node, ConfigurationScope configScope)
		{
            ...
            statement.ForceDisabledAutoMapCompatibilityMode = NodeUtils.GetBooleanAttribute(prop, "forceDisabledAutoMapCompatibilityMode", false);
            statement.ForceEnableAutoMapCompatibilityMode = NodeUtils.GetBooleanAttribute(prop, "forceEnableAutoMapCompatibilityMode", false); 
			return statement;
		}
	}
}
