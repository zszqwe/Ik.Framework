...
namespace IBatisNet.DataMapper.Configuration.Serializers
{
	...
	public sealed class SelectDeSerializer
	{
		...
		public static Select Deserialize(XmlNode node, ConfigurationScope configScope)
		{
            ...
            select.ForceDisabledAutoMapCompatibilityMode = NodeUtils.GetBooleanAttribute(prop, "forceDisabledAutoMapCompatibilityMode", false);
            select.ForceEnableAutoMapCompatibilityMode = NodeUtils.GetBooleanAttribute(prop, "forceEnableAutoMapCompatibilityMode", false); 
