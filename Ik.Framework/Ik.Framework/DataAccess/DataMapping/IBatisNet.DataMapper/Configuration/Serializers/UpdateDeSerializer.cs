...
namespace IBatisNet.DataMapper.Configuration.Serializers
{
	...
	public sealed class UpdateDeSerializer
	{
		...
		public static Update Deserialize(XmlNode node, ConfigurationScope configScope)
		{
            ...
            update.ForceDisabledAutoMapCompatibilityMode = NodeUtils.GetBooleanAttribute(prop, "forceDisabledAutoMapCompatibilityMode", false);
            update.ForceEnableAutoMapCompatibilityMode = NodeUtils.GetBooleanAttribute(prop, "forceEnableAutoMapCompatibilityMode", false); 
