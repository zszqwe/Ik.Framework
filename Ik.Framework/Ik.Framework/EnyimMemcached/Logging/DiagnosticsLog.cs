...
namespace IkCaching
{
	public class DiagnosticsLogFactory : ILogFactory
	{
		...
		public DiagnosticsLogFactory() : this(ConfigurationManager.AppSettings["IkCaching.Diagnostics.LogPath"]) { }

		public DiagnosticsLogFactory(string logPath)
		{
			if (String.IsNullOrEmpty(logPath))
				throw new ArgumentNullException(
					"Log path must be defined.  Add the following to configuration/appSettings: <add key=\"IkCaching.Diagnostics.LogPath\" "
