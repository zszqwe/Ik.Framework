...
namespace IkCaching
{
	...
	///				<section name="log" type="IkCaching.EnyimLoggerSection, Enyim.Caching" />
	///			</sectionGroup>
	///		</configSections>
	///		<enyim.com>
	///			<log factory="IkCaching.Log4NetLoggerFactory, Enyim.Caching" />
	///		</enyim.com>
	/// </configuration>
	/// 
	/// Code:
	...
	public static class LogManager
	{
		...
		static LogManager()
		{
			var section = ConfigurationManager.GetSection("enyim.com/log") as IkCaching.Configuration.LoggerSection;
			ILogFactory f = null;

			if (section != null && section.LogFactory != null)
			{
				f = IkCaching.Reflection.FastActivator.Create(section.LogFactory) as ILogFactory;
			}
#if !log4net
