...
namespace IkCaching.Memcached.Protocol.Text
{
	internal static class TextSocketHelper
	{
		...
		private static readonly IkCaching.ILog log = IkCaching.LogManager.GetLogger(typeof(TextSocketHelper));
		...
		/// <exception cref="T:IkCaching.Memcached.MemcachedException">The server did not specified any reason just returned the string ERROR. - or - The server returned a SERVER_ERROR, in this case the Message of the exception is the message returned by the server.</exception>
		/// <exception cref="T:IkCaching.Memcached.MemcachedClientException">The server did not recognize the request sent by the client. The Message of the exception is the message returned by the server.</exception>
		...
		/// using the <see cref="M:IkCaching.Memcached.PooledSocket.Write(IList&lt;ArraySegment&lt;byte&gt;&gt;)"/>
		/// </summary>
		...
		/// and use the <see cref="M:IkCaching.Memcached.PooledSocket.Write(IList&lt;ArraySegment&lt;byte&gt;&gt;)"/> to send the command and the additional buffers in one transaction.</remarks>
