...
namespace IkCaching.Memcached
{
	...
	{
		private static readonly IkCaching.ILog log = IkCaching.LogManager.GetLogger(typeof(MemcachedNode));
		...
		{
			private static readonly IkCaching.ILog log = IkCaching.LogManager.GetLogger(typeof(InternalPoolImpl).FullName.Replace("+", "."));
