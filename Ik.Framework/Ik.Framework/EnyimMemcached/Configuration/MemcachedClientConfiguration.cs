...
using IkCaching.Memcached.Protocol.Binary;
...
namespace IkCaching.Configuration
{
	...
	public class MemcachedClientConfiguration : IMemcachedClientConfiguration
	{
		...
		/// <summary>
		/// Gets or sets the Type of the <see cref="T:IkCaching.Memcached.IMemcachedNodeLocator"/> which will be used to assign items to Memcached nodes.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="T:IkCaching.Memcached.ITranscoder"/> which will be used serialize or deserialize items.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="T:IkCaching.Memcached.IPerformanceMonitor"/> instance which will be used monitor the performance of the client.
		/// </summary>
