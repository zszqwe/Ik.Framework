...
namespace IkCaching.Configuration
{
	...
	public sealed class MemcachedClientSection : ConfigurationSection, IMemcachedClientConfiguration
	{
		...
		/// <summary>
		/// Gets or sets the <see cref="T:IkCaching.Memcached.IMemcachedNodeLocator"/> which will be used to assign items to Memcached nodes.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="T:IkCaching.Memcached.IMemcachedKeyTransformer"/> which will be used to convert item keys for Memcached.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="T:IkCaching.Memcached.ITranscoder"/> which will be used serialzie or deserialize items.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="T:IkCaching.Memcached.IPerformanceMonitor"/> which will be used monitor the performance of the client.
		/// </summary>
		...
		IServerPool IMemcachedClientConfiguration.CreatePool()
		{
			switch (this.Protocol)
			{
				...
				case MemcachedProtocol.Binary: return new IkCaching.Memcached.Protocol.Binary.BinaryPool(this);
			}
