...
namespace IkCaching.Configuration
{
	...
	public sealed class AuthenticationElement : ConfigurationElement, IAuthenticationConfiguration
	{
		...
		/// </summary>
		[ConfigurationProperty("type", IsRequired = false), TypeConverter(typeof(TypeNameConverter)), InterfaceValidator(typeof(IkCaching.Memcached.ISaslAuthenticationProvider))]
		public Type Type
		{
		...
		Type IAuthenticationConfiguration.Type
		{
			...
			set
			{
				ConfigurationHelper.CheckForInterface(value, typeof(IkCaching.Memcached.ISaslAuthenticationProvider));
