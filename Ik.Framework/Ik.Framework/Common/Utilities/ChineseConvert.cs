...
namespace Ik.Framework.Common.Utilities
{
    public class ChineseConvert
    {
        ...
        /// <param name="ch"></param>        
        /// <returns></returns>        
        public static String GetPinyingFirst(Char ch)
        {
            var rs = GetPinying(ch);
        ...
        public static String GetPinyingFirst(String str)
        {
            ...
            {
                sb.Append(GetPinyingFirst(chs[i]));
            }
        ...
        /// <param name="ch"></param>
        /// <returns></returns>
        public static String GetPinying(Char ch)
        {
            // 拉丁字符            
        ...
        /// <param name="str">汉字字符串</param>
        /// <returns>转换后的拼音(全拼)字符串</returns>
        public static String GetPinying(String str, string delimiter)
        {
            if (String.IsNullOrEmpty(str)) return String.Empty;
            ...
            for (var j = 0; j < chs.Length; j++)
            {
                if (j < chs.Length - 1)
                {
                    sb.Append(GetPinying(chs[j])).Append(delimiter);
                }
                else
                {
                    sb.Append(GetPinying(chs[j]));
                }
            }
